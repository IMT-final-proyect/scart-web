...
const MyDocuments = () => {
    ...
    const driverId: number = useSelector((state: RootState) => {
    ...
    const loadingDocuments = useSelector((state: RootState) => state.documents.drivers.loading)
    ...
    useEffect(() => {
        ...
        if(searchName !== '' || searchState !== ''){
            if(searchState === ''){
                Object.keys(documents).map((key: string, i: any) => {
                    const driverName = documents[parseInt(key)].type.name.toUpperCase()
                ...
                if(searchName === ''){
                    ...
                    Object.keys(documents).map((key: string, i: any) => {
                        const driverName = documents[parseInt(key)].type.name.toUpperCase()
                        if (driverName.includes(searchName.toUpperCase()) && getStateName(documents[parseInt(key)].state) === searchState)
                            documentsAux.push(documents[parseInt(key)])
                    })
                }
            }
        ...
        <>
            <Modal open={openModal} onClose={() => setOpenModal(false)}>
                <CreateDriverDocumentModal
                    driverId={driverId}
                    setOpenDriverDocumentModal={setOpenModal}
                            ...
                            <>
                                ...
                                <Grid container direction='column' justifyContent='space-between' >
                                    ...
                                    <Button
                                        ...
                                        component={Link}
                                        to={ROUTES.root+ROUTES.documentDetails+'/'+documentsFiltered[parseInt(key)].id}
                                    >  
                                        <DocumentRow 
