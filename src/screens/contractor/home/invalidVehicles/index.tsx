...
import { getInvalidVehicles } from "../../../../redux/slices/contractorsSlice";
...
const InvalidVehicles = () => {
    ...
    const vehicles = useSelector((state: RootState) => state.contractors.invalid.vehicles)
    const loadingVehicles = useSelector((state: RootState) => state.contractors.invalid.loading)
    
    useEffect(() => {
        if (!!contractorId) dispatch(getInvalidVehicles(contractorId))
...
export default InvalidVehicles